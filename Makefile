...
VERSION ?= 0.0.1
IMAGE_TAG_BASE ?= workspace.devfile.io/jdevspace
...
## marker
	cat target/kubernetes/devworkspaces.workspace.devfile.io-v1alpha1.yml target/kubernetes/kubernetes.yml | operator-sdk generate bundle -q --overwrite --version 0.1.1 --default-channel=stable --channels=stable --package=jdevspace
